...
1. **Phase 1**: Move shared code → `src/shared/`
2. **Phase 2**: Create module structure → `src/modules/`
3. **Phase 3**: Migrate modules one by one (merge controller + service)
4. **Phase 4**: Update imports and path aliases
5. **Phase 5**: Update route aggregator
...
| v1 | v2 | Migration |
|----|----|-----------|
| `@controllers/parent.controller` | `@modules/users/parent/parent.handler` | Update imports |
| `@services/parent.service` | Merged into handler | Inline service logic |
| `@repositories/parent.repository` | `@modules/users/parent/parent.repository` | Update imports |
| `@middlewares` | `@shared/middlewares` | Update imports |
| `@utils` | `@shared/utils` | Update imports |

### Compatibility Notes

- ✅ API endpoints remain unchanged (no breaking API changes)
- ✅ Database schema unchanged
- ✅ Request/response formats identical
- ⚠️ Import paths require updates
