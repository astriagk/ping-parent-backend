...
} from "@modules/trips/driver-student-assignment/driverStudentAssignment.controller";
import {
  createDriverStudentAssignmentSchema,
  updateDriverStudentAssignmentSchema,
} from "@modules/trips/driver-student-assignment/driverStudentAssignment.validation";
import {
  validate,
  verifyAdminToken,
  verifyDriverToken,
