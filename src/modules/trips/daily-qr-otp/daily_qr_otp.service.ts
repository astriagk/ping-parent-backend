...
import { dailyQrOtpRepository } from "@modules/trips/daily-qr-otp/daily_qr_otp.repository";
import { DailyQrOtp } from "@modules/trips/daily-qr-otp/daily_qr_otp.type";
import {
  AlphabetType,
  ERROR_MESSAGES,
  HTTP_STATUS,
