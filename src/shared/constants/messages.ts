...
export const SUCCESS_MESSAGES = {
  ADDRESS: {
    ADDRESS_UPDATED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_UPDATED,
  },
  ADMIN: {
  ...
  AUTH: {
    ...
    USER_DELETED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_DELETED,
    USER_FETCHED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_FETCHED,
    USER_UPDATED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_UPDATED,
    USERS_LIST_FETCHED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.LIST_FETCHED,
  },
  DAILY_QR_OTP: {
  ...
  DRIVER: {
    ...
    DETAILS_FETCHED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_FETCHED,
    DOCUMENTS_UPDATED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_UPDATED,
    PROFILE_CREATED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_CREATED,
    PROFILE_UPDATED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_UPDATED,
  },
  DRIVER_STUDENT_ASSIGNMENT: {
  ...
  PARENT_SUBSCRIPTION: {
    CANCELLED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_DELETED,
  ...
  SCHOOL_ADMIN: {
    DEACTIVATED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_DELETED,
    LIST_RETRIEVED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.LIST_FETCHED,
    ...
    RETRIEVED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_FETCHED,
    UPDATED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_UPDATED,
  },
  SCHOOL_SUBSCRIPTION: {
    ACTIVE_RETRIEVED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_FETCHED,
    CANCELLED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_DELETED,
    CODES_FETCHED_SUCCESSFULLY: SUCCESS_MESSAGES_COMMON.RESOURCE_FETCHED,
